...
if __name__ == '__main__':
    ...
    USN = [(7.747,3.145,762,'MTN'),(7.918,3.215,762,'IOWA'),(7.788,3.162,701,'MS/NC')]
    IJN = [(5.100,2.601,780,'SY'),(5.397,2.483,780,'YMT'),(9.240,3.788,806,'AMG'),(8.910,3.653,806,'NGT'),(8.866,3.156,775,'FS')]
    HMS = [(6.773,3.095,762,'L3'),(8.127,3.300,725,'LION'),(8.571,3.051,757,'KGV'),(11.087,4.501,788,'NS')]
    KMS = [(7.015,3.367,805,'H42-480'),(7.024,2.950,810,'H42-420'),(7.194,2.921,810,'H39'),(8.600,3.268,820,'BSM')]
    for i in USN:
        plt.scatter(i[0],i[2],s = 10,c = 'blue')
        #plt.annotate(i[3],(i[0],i[2]))
    for i in IJN:
        plt.scatter(i[0],i[2],s = 10,c = 'gold')
        #plt.annotate(i[3],(i[0],i[2]))
    for i in HMS:
        plt.scatter(i[0],i[2],s = 10,c = 'red')
        #plt.annotate(i[3],(i[0],i[2]))
    for i in KMS:
        plt.scatter(i[0],i[2],s = 10,c = 'black')
        #plt.annotate(i[3],(i[0],i[2]))
    plt.xlabel('弹速衰减系数',fontproperties=font)
